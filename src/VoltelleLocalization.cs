...
namespace MVolt.Rebuild
{
    ...
    internal static class VoltelleLocalization
    {
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            { "当前实现使用 38 个唯一 QueryInterface ID；其中 0x527FC458 用于 Crossbar MeasureFrequency。", "The current implementation uses 38 unique QueryInterface IDs; 0x527FC458 is used for Crossbar MeasureFrequency." },
